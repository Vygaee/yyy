...
async def gen_thumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            ...
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"DANTE MUSIC IS PLAYING OP",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
                f"DANTE Music One Of The Most Advanced Telegram Music Bot", font=arial
            )
            draw.text(
                ((1280 - text_w) / 2, 80),
                f"DANTE Music One Of The Most Advanced Telegram Music Bot",
                fill="green",
                font=arial,
            )
            if para[0]:
            ...
            pass
        text_w, text_h = draw.textsize(f"YouTube: Cinta", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"YouTube: Cinta",
            fill="white",
...
async def gen_qthumb(videoid, user_id, theme):
    ...
    try:
        ...
        try:
            ...
            draw.text(
                ((1280 - text_w) / 2, 30),
                f"DANTE ADDED THIS SONG TO QUEUE",
                fill="red",
                font=font,
            )
            text_w, text_h = draw.textsize(
            ...
            pass
        text_w, text_h = draw.textsize(f"YouTube: Naruto", font=arial)
        draw.text(
            ((1280 - text_w) / 2, 620),
            f"YouTube: Naruto",
            fill="white",
